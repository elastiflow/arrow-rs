...
mod tests {
    ...
    fn encode_avro_float(value: f32) -> Vec<u8> {
    ...
    fn test_schema_resolution_promotion_int_to_float() {
        ...
        assert_eq!(a.value(0) as f64, 0.0);
        assert_eq!(a.value(1) as f64, 42.0);
        assert_eq!(a.value(2) as f64, -7.0);
    }
    ...
    fn test_schema_resolution_promotion_long_to_float() {
        ...
        let a = arr.as_any().downcast_ref::<Float32Array>().unwrap();
        assert_eq!(a.value(0) as f64, 0.0);
        assert_eq!(a.value(1) as f64, 1_000_000.0);
        assert_eq!(a.value(2) as f64, -123.0);
    }
